            ...
            <div class="" id="nav-penunjang" aria-labelledby="nav-penunjang-tab" tabindex="0">
              <div class="row row-cols-1 row-cols-lg-2 px-3 px-md-5 g-0 g-md-4 g-lg-5">
                ...
                <div class="col">
                  ...
                  <div class="mb-4">
                    <label for="tanggal_pendaftaran" class="form-label fw-bold">Tanggal Pendaftaran <small class="fw-semibold">[Bulan/Tanggal/Tahun]</small> <span class="text-danger">*</span></label>
