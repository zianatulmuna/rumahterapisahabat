              ...
              <div class="row row-cols-1 row-cols-lg-2 px-3 px-md-5 g-0 g-md-4 g-lg-5">
                ...
                <div class="col">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="number" class="form-control @error('jumlah_bayar') is-invalid @enderror" id="jumlah_bayar" name="jumlah_bayar" value="{{ old('jumlah_bayar') }}" wire:model="jumlah_bayar">
                    @error('jumlah_bayar')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
              ...
              <div class="row row-cols-1 row-cols-md-2 px-3 px-md-5 g-0 g-md-4 g-lg-5">
                ...
                <div class="col">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('ket_status') is-invalid @enderror" id="ket_status" name="ket_status" value="{{ old('ket_status') }}" oninput="capFirst('ket_status')" wire:model="ket_status">
                    @error('ket_status')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
...
@push('script')
  <script>
    ...
    function breakLine(inputId) {
      var input = document.getElementById(inputId);
      var textarea = input.value;
