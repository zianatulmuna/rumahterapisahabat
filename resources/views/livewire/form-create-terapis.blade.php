<div>
    <div class="main-bg">
      {{-- Step header --}}
      <div class="row justify-content-between py-4 py-sm-5">
        ...
        <div class="tab-content m-0" id="nav-tabContent">
          ...
          @if($currentStep == 1)
            <div class="" id="nav-diri" aria-labelledby="nav-diri-tab" tabindex="0">
              <div class="row p-5">
                <div class="col" style="padding: 0 30px 0 20px;">                
                  <div class="mb-3">
          ...
          @if($currentStep == 2)
            <div class="" id="nav-penunjang" aria-labelledby="nav-penunjang-tab" tabindex="0">
              <div class="row p-5">   
                <div class="col" style="padding: 0 30px 0 20px;">
                  <div class="mb-3">
                    <label class="form-label fw-semibold">Tingkatan Terapis</label>
                  ...
                  <div class="mb-3">
                    <label for="total_terapi" class="form-label fw-semibold">Total Terapi</label>
                  ...
                  <div class="mb-3">
                    <label label class="form-label fw-semibold w-100">Status Terapis</label>
                ...
                <div class="col" style="padding: 0 30px 0 20px;">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <button type="button" class="input-group-text border-start-0 bg-white @error('password') input-group-text-danger @enderror" id="mybutton" onclick="passwordAction()"><i class="bi bi-eye-fill text-secondary"></i></button>
                    </div>
          ...
          {{-- button step --}}
          <div class="d-flex justify-content-between mb-5 mx-5 form-navigation">
            @if($currentStep == 1)
              <div></div>    
              <button class="btn btn-primary me-3" type="button" style="padding: 10px 30px;" wire:click="toNext()">Lanjut</button>       
            @endif
  
            @if($currentStep == 2)
              <button class="btn btn-secondary ms-3" type="button" wire:click="toPrev()">Sebelumnya</button>    
              <button type="submit" class="btn c-btn-success me-3" style="padding: 10px 30px;">Kirim</button>        
            @endif
          </div>
        </div>
      </form>
