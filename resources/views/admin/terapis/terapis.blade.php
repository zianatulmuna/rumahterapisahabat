...
<div class="content-container">
  ...
  <div class="d-flex justify-content-between my-4 gap-3">
    <form action="/admin/terapis" class="custom-search shadow-sm">
      ...
      <div class="input-group">
        ...
        <input type="search" name="search" value="{{ request('search') }}" class="form-control py-2 border-start-0" placeholder="Cari Nama Terapis" aria-label="Search" aria-describedby="search-addon" />
        <button type="submit" class="btn btn-outline-success px-4">Cari</button>
      </div>        
      </form>
  ...
  <div class="pt-3 pb-2 mb-3">
    @if(count($terapis) > 0)
      <div class="row row-cols-2 row-cols-md-3 row-cols-xl-4 row-cols-xxl-5 g-2 g-xl-4 g-xxl-3">
        @foreach ($terapis as $t)
          <div class="col">
            <div class="card card-custom card-terapis shadow-sm">
