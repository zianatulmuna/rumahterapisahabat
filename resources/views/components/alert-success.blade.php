...
@push('script')  
    @if(session()->has('create'))
        <script>
            document.querySelector('.header-color').classList.add('text-success');
    ...
    @elseif(session()->has('update'))
        <script>
            document.querySelector('.header-color').classList.add('text-primary');
            document.querySelector('.header-message').textContent = "Update Success";
        </script>
    @elseif(session()->has('delete'))
        <script>
            document.querySelector('.header-color').classList.add('text-danger');
