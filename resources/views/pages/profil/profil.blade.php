...
@section('container')
  <div class="content-container">
    <div class="align-items-center border-bottom mb-4 pb-2">
      <h2>Data User</h2>
    </div>
    ...
    <div class="d-flex align-items-center justify-content-center">
      <div class="d-flex align-items-center justify-content-center">
        @if ($user->foto)
          <img src="{{ asset('storage/' . $user->foto) }}" class="img-thumbnail" alt="{{ $user->nama }}"
            style="height: 240px; width: auto;">
        @else
          @if ($user->jenis_kelamin === 'Laki-Laki')
            <img src="/img/avatar-l.png" class="img-thumbnail" alt="{{ $user->nama }}"
              style="height: 240px; width: auto;">
          @else
            <img src="/img/avatar-p.png" class="img-thumbnail" alt="{{ $user->nama }}"
              style="height: 240px; width: auto;">
          @endif
        @endif
      </div>
    ...
    <table class="table-admin mx-auto mt-4 table border shadow-sm">
      <tbody>
        <tr>
          <td>
            <div class="row row-cols-1 row-cols-sm-2 mt-3">
              <div class="col px-md-5 mb-3 px-4">
