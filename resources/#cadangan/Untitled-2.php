...
class PasienEditForm extends Component
{
    ...
    public $pasien, $rm, $id_pasien, $id_rekam_medis, $slug, $dbNama, $dbFoto, $pathFoto, $dbTahun_pendaftaran, $dbTanggal_ditambahkan, $id_rm_baru, $isPasienLama, $sistemOption, $updatePenyakit, $dataRM;
    ...
    public function validateData() {
        ...
        match ($this->currentStep) {
            ...
            3 => $this->validate(
                $dataRequest->rules3($this->id_pasien,$this->id_rekam_medis,$this->tempat_layanan,$this->status_pasien), 
                $dataRequest->messages()
            ),
            4 => $this->validate(
    ...
    public function updateRekamMedis() {
        ...
        $this->dataRM['sistem_layanan'] = $this->sistem_layanan == '' ? $this->sistemOption : $this->sistem_layanan. ' ' . $this->sistemOption; 
    ...
    public function newRekamMedis() {
        $idRM = IdGenerator::generate(['table' => 'rekam_medis', 'field' => 'id_rekam_medis', 'length' => 10, 'prefix' => $this->k_bsni.date('ym'), 'reset_on_prefix_change' => true]);

        $this->dataRM['id_rekam_medis'] = $idRM;
        $this->dataRM['id_pasien'] = $this->id_pasien;
        $this->dataRM['penyakit'] = implode(',', $this->tag);

        $createRM = RekamMedis::where('id_rekam_medis', $this->id_rekam_medis)->update($this->dataRM);
    ...
    public function update(Request $request, Pasien $pasien) {
        ...
        $rmCheck = $this->isPasienLama ? true : false;
