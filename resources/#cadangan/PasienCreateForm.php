...
class PasienCreateForm extends Component
{
    ...
    public function storePasien() {
        ...
        $this->id_pasien = IdGenerator::generate(['table' => 'pasien', 'field' => 'id_pasien', 'length' => 10, 'prefix' => $this->k_bsni.date('ym'), 'reset_on_prefix_change' => true]);
        ...
        $dataDiri['tanggal_pendaftaran'] = $this->tanggal_pendaftaran . ' ' . date('H:i:s');
